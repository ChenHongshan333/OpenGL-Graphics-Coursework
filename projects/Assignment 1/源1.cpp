// name: Hongshan
// 2 extra functions I used: glPointSize(), glutSwapBuffers()
...
void display() {
    ...
    // whisker dots using glPointSize()
    glPushMatrix();
    glColor3f(0.0f, 0.0f, 0.0f);
    glPointSize(6.0f);  // extra function
    glBegin(GL_POINTS);
    ...
    glutSwapBuffers();  // extra function
}
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Cute Cat (OpenGL)");
